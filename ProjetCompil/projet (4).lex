...
{types_appareil} {return new Symbol (sym.t_Type, new Integer(yytext()));}
{sous_types} {return new Symbol (sym.t_sous_Type, new Integer(yytext()));}
...
{types_interface} {return new Symbol (sym.t_Interface);}
{commandes} {return new Symbol (sym.t_commande);}
{actions} {return new Symbol (sym.t_action);}
{etats} {return new Symbol (sym.t_etat);}
